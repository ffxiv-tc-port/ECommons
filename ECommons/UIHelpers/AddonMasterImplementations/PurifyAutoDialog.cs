...
public partial class AddonMaster
{
    public unsafe class PurifyAutoDialog : AddonMasterBase<AtkUnitBase>
    {
        ...
        /// <remarks>
        /// 🔴 原本是三段全裸的鏈:<c>GetComponentButtonById(16)</c>、<c>SearchNodeById(2)</c>、
        ...
        /// 任何一跳取不到就回空字串:下游 <see cref="PurificationActive"/>/<see cref="PurificationInactive"/>
        /// 比對的 Addon 列文字皆非空,空字串一律比不中⇒兩者同時為 <see langword="false"/>(fail-closed,不動作)。
        /// </remarks>
        public SeString CancelExitButtonSeString
        {
            get
            {
                var button = CancelExitButton;
